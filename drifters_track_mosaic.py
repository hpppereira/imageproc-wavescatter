...
if __name__ == '__main__':
    ...
    dict_videos = {
                   'T100_010300': ['00:08','01:09'],
                   'T100_020100': ['00:08','01:10'],
                   'T100_020200': ['00:08','01:05'],
                   'T100_020201': ['00:09','01:24'],
                   'T100_020300': ['00:08','01:09'],
                   'T100_030100': ['00:12','01:13'],
                   'T100_030200': ['00:09','01:26'],
                   'T100_030300': ['00:08','01:11'],
                   'T100_040100': ['00:08','02:13'],
                   'T100_040300': ['00:09','01:57'],
                   'T100_050100': ['00:07','01:19'],
                   'T100_050300': ['00:08','01:20'],
                   }
...
#        pathname_video = os.environ['HOME'] + '/gdrive/coppe/lioc/wavescatter_data/DERIVA_RANDOMICA/VIDEO/CAM{}/T100/'.format(ncam)
        ...
        if track_balls == True:
            ...
            for i in np.arange(0,len(dtimevec)-1,1):
...
#                cont_frame2 = cont_frame2 - 6
        ...
        if save_balls_paths:
            ...
            df.to_csv(pathname_output + 'paths_%s.csv' %experiment)
            df.to_pickle(pathname_output + 'paths_%s.pkl' %experiment)
